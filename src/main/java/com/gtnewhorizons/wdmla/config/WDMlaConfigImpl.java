 ...
 */
public class WDMlaConfigImpl extends Configuration implements WDMlaConfig {

    public static WDMlaConfigImpl _instance;

    public WDMlaConfigImpl(File configFile) {
        super(configFile);
        _instance = this;
    }
    ...
    private void reloadProviderAutogenConfigs() {
    ...
    @Override
    public TimeFormattingPattern getTimeFormatter(ITimeFormatConfigurable provider) {
        return loadEnum(
                provider.getConfigCategory(),
                "option.wdmla.autogen.time.format",
                provider.getDefaultTimeFormatter(),
                "");
    }

    private <T extends Enum<T>> T loadEnum(String category, String name, T defaultValue, String comment) {
    ...
    @Override
    public void setCategoryLangKey(String category, String languageKey) {
        setCategoryLanguageKey(category, languageKey);
    }
}
